...
Именование переменных. По той же причине что системы часто работают только с одним аспектом, возвращаемый запросом Where аспект можно называть просто `a`, а сущности внутри  foreach просто `e`.
